 ...
 *
 * Run with:  npx playwright test mobile --project="mobile-chrome" --project="mobile-safari"
 *
 * The Playwright config already defines mobile-chrome (Pixel 7, 412x915)
 * and mobile-safari (iPhone 14, 390x844). These tests validate layout and
 * usability at those sizes.
 */
